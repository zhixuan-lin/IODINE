...
from lib.modeling.modules import Dense


class IterNetV18(nn.Module):
    """
    My, nothing other than more layers, except elu, use gate
    """
    def __init__(self, dim_in, dim_latent, n_iters=12):
        ...
        self.encoder = MLP(self.input_size(), 512, 512, 'elu')
        self.gaussian = GaussianLayer(512, dim_latent)
        self.decoder = MLP(dim_latent, 512, 512, 'elu')
        self.bernoulli = Dense(512, dim_in, 'sigmoid')
